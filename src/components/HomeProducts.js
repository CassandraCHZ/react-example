            ...
            <div class="row row-cols-1 row-cols-md-4 g-4">
                <div class="col">
                    <div class="card border-info mb-3 card text-center">
                        <img
                            src="https://latam-editorial.pxcrush.net/soloautos/general/editorial/volkswagen_virtus_2023_oficial_india_mx_03.jpg"
                            title="Volkswagen"
                            class="card-img-top"
                            alt="Volkswagen" />
                        <div class="card-body">
                            <h5 class="card-title">Volkswagen 2015</h5>
                            <p class="card-text">$59,895</p>
